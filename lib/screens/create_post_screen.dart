      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            StatefulBuilder( // Use StatefulBuilder for the button's loading state
              builder: (BuildContext context, StateSetter setState) {
                return SizedBox( // Ensure button stretches
                    ...
                    onPressed: isSubmitting ? null : () async {
                      if (titleController.text.trim().isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text("Title cannot be empty!"), backgroundColor: Colors.orange),
                        );
                        return;
                      }
                      ...
                      try {
                        ...
                        await supabase.from('forum_posts').insert({
                          ...
                          'description': descriptionController.text.trim(), // Keep if needed, else remove
                        ...
                        Navigator.pop(context, true); // Go back to forum screen and indicate success
                        ...
                        if (e.toString().contains('permission-denied')) {
                          errorMessage = "You don't have permission to create posts. Make sure you're signed in.";
                        }
