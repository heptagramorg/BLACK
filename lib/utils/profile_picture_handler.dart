...
class ProfilePictureHandler {
  ...
  static Future<void> _deleteOldProfilePicture(
      String oldProfilePictureUrl) async {
    try {
      print("Attempting to delete old profile picture: $oldProfilePictureUrl");

      // Extract path from URL
      final String? oldFilePath =
          _extractStoragePathFromUrl(oldProfilePictureUrl);
      ...
      if (oldFilePath != null) {
        ...
        print(
            "Could not extract path from old profile picture URL: $oldProfilePictureUrl");
      }
    } catch (e) {
